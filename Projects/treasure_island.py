...
choice_1 = input(
    'You have come across two paths - do you want to go left or right: ')
if choice_1.lower() == 'left':
    choice_2 = input('You come across a river.  Do you want to swim or wait: ')
    if choice_2.lower() == 'wait':
        choice_3 = input(
            'You see three doors.  Which do you choose (red/blue/yellow): ')
        ...
        print('You were attacked by fish.  Game Over.')
    else:
        print('That is not an option.  Game Over.')
elif choice_1 == 'right':
